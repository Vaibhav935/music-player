...
const Login = ({ setToggle }) => {
  ...
  return (
    <div className="min-h-screen bg-[#121212] text-white flex justify-center pt-25">
      <div className="w-95">
        <div className="sc-e572410e-1 boatMp h-8 flex justify-center">
          <svg
            fill="white"
            role="img"
            viewBox="0 0 24 24"
            className="e-91132-logo e-91132-baseline"
            aria-label="Spotify"
            aria-hidden="false"
        ...
        <h1 className="text-5xl font-bold text-center w-full py-3">
          Welcome back
        </h1>
        <form
        ...
        >
          ...
          <input
            ...
            type="text"
            className={`border w-full h-12 text-2xl rounded  px-1  ${
              errors.email ? "border-red-500 outline-none" : "border-[#B3B3B3]"
            }`}
          />
          {errors.email ? (
            <p className="text-red-600 text-sm flex gap-1">
              <CircleAlertIcon /> This email is invalid. Make sure it's written
              like example@email.com
            </p>
          ) : null}
          <button className="bg-[#22D963] text-lg font-bold h-12 rounded-full text-black cursor-pointer hover:scale-103 hover:bg-[#38d770]">
            Continue
          </button>
        </form>
        <div>
          <div className="px-5 ">
            ...
            <div className="flex flex-col gap-2 pt-5">
              <a className="flex border border-[#B3B3B3] px-4 py-3 gap-2 rounded-full cursor-pointer hover:scale-103 hover:border-white ">
                <span
                  aria-hidden="true"
                  className="e-91132-button__icon-wrapper"
                >
                  <svg
                    width="25"
                    height="24"
                    ...
                    role="img"
                    aria-hidden="true"
                    className="e-91132-icon e-91132-baseline"
                    viewBox="0 0 24 24"
                  >
                    <path d="M5 5a3 3 0 0 1 3-3h8a3 3 0 0 1 3 3v14a3 3 0 0 1-3 3H8a3 3 0 0 1-3-3zm3-1a1 1 0 0 0-1 1v14a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1V5a1 1 0 0 0-1-1z"></path>
                    <path d="M13.25 16.75a1.25 1.25 0 1 1-2.5 0 1.25 1.25 0 0 1 2.5 0"></path>
                  </svg>
                </span>
          ...
          <div className="p-5 mt-10">
            <p className="text-xs text-[#B3B3B3]  text-center font-semibold">
              This site is protected by reCAPTCHA and the Google{" "}
              <span className="underline hover:text-[#22D963] cursor-pointer">
                Privacy Policy
              </span>{" "}
              and{" "}
              <span className="underline hover:text-[#22D963] cursor-pointer">

  ...
  return (
    <div className="bg-[#121212] w-[30%] rounded-2xl h-full p-3 pt-5">
      ...
      <div className="flex gap-3 mt-6 px-2">
        <h1 className="px-3 py-1.5 cursor-pointer bg-[#2A2A2A] font-semibold text-sm rounded-full">
          Artists
        </h1>
        <h1 className="px-3 py-1.5 cursor-pointer bg-[#2A2A2A] font-semibold text-sm rounded-full">
          Podcasts & Shows
      ...
      <div className="flex items-center justify-between mt-4 text-[#abaaaa] px-2">
        ...
        <div className="flex items-center gap-2">
          ...
          <svg
            ...
            role="img"
            aria-hidden="true"
            className="h-4 e-91000-icon e-91000-baseline e-91000-icon--auto-mirror cursor-pointer"
            viewBox="0 0 16 16"
          >
      ...
      <div className="flex items-center gap-3 rounded-lg py-2 px-1.5 mt-4 cursor-pointer hover:bg-[#1F1F1F]">
        <NavLink to='/home/collection' className={(isActive) => isActive ? `flex gap-3 w-full rounded` : `flex gap-3 w-full rounded`}>
          ...
          <div>
            ...
            <p className="text-[#AEAEAE] text-sm">
              Playlist <span>{likedList.length}</span>
            </p>
          </div>
        </NavLink>
      </div>

  ...
  return (
    <div className="h-[8%] flex items-center pl-8 justify-between pr-5">
      <div className="flex items-center gap-7">
        <div className="sc-e572410e-1 boatMp h-8">
          <svg
            fill="white"
            role="img"
            viewBox="0 0 24 24"
        ...
        <div className="flex gap-5">
          ...
          <div className="flex items-center px-5 py-1 bg-[#2A2A2A] rounded-full gap-3">
            <svg
              ...
              role="img"
              aria-hidden="true"
              className="h-5 e-91000-icon e-91000-baseline MpoH5sdgCUbPL5LCl3Cy"
            ...
            />
            <div className="border-l pl-4 border-l-[#FFFFFF]">
              <svg
                fill="white"
                data-encore-id="icon"
                role="img"
                aria-hidden="true"
                className="h-5 e-91000-icon e-91000-baseline"
                viewBox="0 0 24 24"
              >
